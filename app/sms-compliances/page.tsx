  ...
  return (
    <>
      ...
      <main className="bg-[#0A1220] text-[#F3F8FF] min-h-screen">
        {/* Hero Section */}
        <section className="relative pt-16 sm:pt-32 pb-10 sm:pb-20 px-4 sm:px-6 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto relative z-10 text-center">
            ...
            <p className="text-base sm:text-xl text-[#8DA0C0] leading-relaxed max-w-3xl mx-auto">
        ...
        {/* Table Section */}
        <section className="pb-16 sm:pb-24 px-4 sm:px-6 relative z-20">
          <ComplianceTable />
        </section>
      </main>
      <Footer />
