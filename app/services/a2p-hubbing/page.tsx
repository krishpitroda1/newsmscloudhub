...
export const metadata: Metadata = {
  ...
  description: "Carrier-grade A2P SMS hubbing services. Connect your SMSC to 300+ direct operator routes globally with full DLR transparency and bilateral revenue sharing.",
};
      ...
      <main className="bg-[#0A1220] text-[#F3F8FF]">
        <section className="relative overflow-hidden pt-28 pb-20 px-6">
          ...
          <div className="max-w-4xl mx-auto relative">
            ...
            <p className="text-lg text-[#8DA0C0] max-w-2xl leading-relaxed mb-10">Connect your SMSC to our hub and gain immediate access to 300+ direct operator routes across 150+ countries. No need for bilateral negotiations with every destination operator — we've already done it. Full DLR reporting, revenue share, and transparent per-route pricing.</p>
        ...
        <section className="py-20 px-6 border-t border-white/5">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10">
            ...
            <div className="space-y-4">
              ...
              {[{label:"Connected operators",value:"300+"},{label:"Countries",value:"150+"},{label:"Monthly messages through hub",value:"1B+"},{label:"DLR accuracy",value:"98.87%"},{label:"Hub uptime SLA",value:"99.95%"}].map(m => (
