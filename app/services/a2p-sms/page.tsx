...
export const metadata: Metadata = {
  ...
  description: "As a global Hub we work with more than 525+ Operators & Carriers on 0hop or 1hop to terminate messages in more than 185+ countries.",
};
      ...
      <main className="bg-[#0A1220] text-[#F3F8FF]">
        <section className="relative overflow-hidden pt-28 pb-20 px-6">
          ...
          <div className="max-w-4xl mx-auto relative">
            ...
            <p className="text-lg text-[#8DA0C0] max-w-2xl leading-relaxed mb-10">As a global Hub we work with more than 525+ Operators & Carriers on 0hop or 1hop. We can terminate messages in more than 185+ countries, delivering unparalleled global reach and reliability.</p>
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10">
            <div>
              ...
              <ul className="space-y-4">
                {[
                  "Global Hub connected to 525+ Operators & Carriers on 0hop or 1hop",
            ...
            <div className="space-y-4">
              ...
              {[
                { label: "Operators & Carriers", value: "525+" },
